...
const useEntranceExcle = () => {
	...
	return (
		<div className='TableDataImport'>
			...
			<Table style={{ height: '100%' }} scroll={{ x: '100%', y: 'calc( 100vh - 270px )' }} rowKey={record => record.key} bordered loading={tableLoading} size='small' dataSource={tableData} columns={columns} />
		</div>
	);
};

export default useEntranceExcle;
