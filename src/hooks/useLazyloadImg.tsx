...
const UseLazyloadImg: React.FC<LazyloadProps> = props => {
	...
	useEffect(() => {
		let checkVisible = () => {
			...
			const isVisible = offsetTop - offsets[0] <= intersectionHeight && offsetTop + height + offsets[0] >= 0 && offsetLeft - offsets[1] <= intersectionWidth && offsetLeft + width + offsets[1] >= 0;
